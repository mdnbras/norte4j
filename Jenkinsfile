...
pipeline {
    ...
    parameters {
        ...
        gitParameter(name: 'BRANCH_TAG', type: 'PT_BRANCH_TAG', description: 'branch/tag to build', sortMode: 'DESCENDING_SMART', quickFilterEnabled: true, branchFilter: 'origin/master')
    }
